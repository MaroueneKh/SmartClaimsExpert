...
class SpinnerFilterCustomAdapter(val context: Context, var dataSource: List<FiltreModel>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        val vh: ItemHolder
        if (convertView == null) {
            view = inflater.inflate(R.layout.custom_spinner_filtres, parent, false)
            vh = ItemHolder(view)
            view?.tag = vh
        } else {
            view = convertView
